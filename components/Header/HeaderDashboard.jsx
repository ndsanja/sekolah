          ...
          <div className="flex items-center justify-between py-2 px-4 border-b border-gray-300">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                />
                <button className=" p-1.5 flex items-center justify-center bg-blue-800  focus:outline-none rounded rounded-l-none">
                  <svg
            ...
            <div className="flex items-center space-x-1">
              <div className="hover:bg-blue-50 p-2 rounded-full flex items-center justify-center cursor-pointer">
                <svg
              ...
              <a href="#">
                <div className="hover:bg-blue-50 p-2 rounded-full flex items-center justify-center">
                  <svg
                    className="h-6 w-6 text-gray-700"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <div className="flex items-center space-x-2 hover:bg-blue-100 rounded-full p-2 cursor-pointer">
                <img
                  ...
                  className="h-8 w-8 rounded-full ring ring-pink-300"
                />
