            ...
            <div className="flex items-center space-x-1">
              <div onClick={toogleDark}>
                {dark ? (
                  ...
                  >
                    <Icon.Dark className="h-6 w-6 text-gray-700 dark:text-blue-100" />
                  </button>
                ) : (
                  <button
                    ...
                    className="hover:bg-blue-50 dark:hover:bg-blue-800 p-2 rounded-full flex items-center justify-center cursor-pointer focus:outline-none"
                  >
                    <Icon.Light className="h-6 w-6 text-gray-700 dark:text-blue-100" />
                  </button>
                )}
              </div>
              ...
              <a href="#">
                <div className="hover:bg-blue-50 dark:hover:bg-blue-800 p-2 rounded-full flex items-center justify-center">
                  <Icon.Bell className="h-6 w-6 text-gray-700 dark:text-blue-100" />
                </div>
              </a>
