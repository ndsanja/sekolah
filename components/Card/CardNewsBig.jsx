      ...
      <div className="bg-gray-100 shadow-xl">
        <div className="overflow-hidden relative h-screen ">
          <img
            ...
            alt=""
          />
          <div className="bg-gray-900 top-0 bottom-0 right-0 left-0 absolute z-10 opacity-70 "></div>
          <div className=" top-0 bottom-0 right-0 left-0 absolute z-20 flex flex-col justify-center items-center text-gray-50 space-y-8 px-8 leading-relaxed">
            <h1 className=" text-4xl">Ini Adalah judul</h1>
